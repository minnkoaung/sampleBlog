        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown<?php echo (strstr(uri_string(), 'admin/pesonals')) ? ' active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button person'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/personals') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/personals'); ?>"><?php echo lang('admin button person_list'); ?></a></li>
                            <li class="<?php echo (uri_string() == 'admin/personals/add') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/personals/add'); ?>"><?php echo lang('admin button person_add'); ?></a></li>
                        </ul>
                    </li>

                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/portfilios')) ? ' active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button portfilio'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/portfilios') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/portfilios'); ?>"><?php echo lang('admin button portfilio_list'); ?></a></li>
